<?php get_header() ?>
    ...
    <div class="main-page-day">
      <main class="morning-quest">
        <div class="shape night-shape"></div>
        <div class="mountain-day">
          <img class="mountain-night-image" src="<?php echo get_template_directory_uri() ?>/img/night-mountain.png">
          <div class="malice-big">
            <img class="malice-big-image" src="<?php echo get_template_directory_uri() ?>/img/malice-big.png">
          </div>
        </div>
        <div class="info">
          <div class="inner-info"> 
            <div class="dialogue">
              <div class="rectangle-rounded night-rectangle-mobile">
                <div class="wizard-text night-wizard-text-mobile">
                <h3 class="are-ye-ready-container">
                  <p class="are-ye-ready"><?php echo $dialogue ?></p>
                  <p class="then-buckle-up"><?php echo $dialogue2 ?></p>
                </div>
              </div>
        ...
        <div class="about1 night-about-section">
          <div class="about-details night-about-deails">
              ...
              <div class="story-details"> 
                ...
                <div class="description-parent">
                  <div class="description-box">
                      ...
                      <p class="description-text-under-night"><?php echo $question ?></p>
                  ...
                  <div class="big-welcome">
                    <div class="welcome-to-fanstasy-quest">
                      <h2 class="welcome-to-text"><?php echo $welcometo ?></h2>
                      <div class="meet-our-characters-wrapper">
                        <h2 class="meet-our-characters"><?php echo $meetour ?></h2>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="fairy-and-mushroom">
                    <img class="mushroom-img" alt="" src="<?php echo get_template_directory_uri() ?>/img/mushroom.png"/>
                    <img class="fairy-img" alt="" src="<?php echo get_template_directory_uri() ?>/img/fairy.png"/>
                </div>
              </div>
            </div>
